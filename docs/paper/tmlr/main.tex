...
\begin{figure}[t]
\centering
\includegraphics[width=0.86\linewidth]{../figures/fig6_scoreboard.pdf}
...
four-of-five majority: P2 $\times$ S2P replicates.
...
(20k-step $\log_{10}$ condition-number median $9.18$--$9.70$).
